...
class NotionTools(Toolkit):
    ...
    Args:
        ...
        create_page (bool): Whether to register the create_page tool.
        update_page (bool): Whether to register the update_page tool.
        search_pages (bool): Whether to register the search_pages tool.
